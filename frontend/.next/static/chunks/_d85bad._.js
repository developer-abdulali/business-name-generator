(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_d85bad._.js", {
...
const JobCard = ({ job })=>{
    ...
    const isSaved = savedJobs.some((savedJob)=>savedJob._id === job._id);
    const [companyInfo, setCompanyInfo] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null); // Initialize as null
    console.log("companyInfo", companyInfo); // Debugging line
    const fetchCompanyInfo = async ()=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constant$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["COMPANY_API_ENDPOINT"]}/get/${job.company}`, {
                withCredentials: true
            });
            if (res.data.success) setCompanyInfo(res.data.company);
        } catch (error) {
...
_s(JobCard, "CdbXaG3wxw+wVpI7pN/jpA8cpIw=", false, function() {
    return [
...
//# sourceMappingURL=_d85bad._.js.map