(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_c58689._.js", {
    ...
    const logoutHandler = async ()=>{
        try {
            ...
            if (res && res.data && res.data.success) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(res.data.message || "Logout failed. Please try again.");
            }
        } catch (error) {
            console.error(error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(error.response?.data?.message || "An error occurred during logout.");
        }
    };
...
//# sourceMappingURL=_c58689._.js.map